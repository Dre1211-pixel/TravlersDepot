...
const Cart = () => {
    ...
    const isMobile = screenWidth < 992; // f螢幕寬 < 992，返回true，否則返回false
        ...
        <>
            <div className="container">
                <section className="cartList py-5 mb-md-5" id="cartList">
                    <h2 className={`${isMobile ? 'h3' : 'h2'} text-center mb-5 mt-5`}>
                        <span>購物車</span>
                    </h2>
                    {cartList.carts?.length === 0 && (
                        <p className="fs-5 text-secondary text-center">
                            購物車還沒有任何商品喔！趕快去逛逛吧！！
                            <br />
                            <Link to="/productList/all" className="btn-product mt-4 ">
                                查看所有商品
                            </Link>
                        </p>
                    )}
                    {cartList.carts?.length >= 1 && (
                        <div>
                            <div className="text-end mb-4">
                                <button
                                    className="btn clearBtn btn-sm d-inline-flex align-items-center justify-content-center gap-2"
                                    type="button"
                            ...
                            <table className="table align-middle cartTable">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th className="text-end qty-adjust" style={{ width: '200px' }}>
                                            數量/單位
                                        </th>
                                ...
                                {cartList.carts?.map((cart) => (
                                    ...
                                    <td data-label="顏色">
                                        <div className="d-inline-flex align-items-center">
                                            ...
                                            {cart.color ? cart.color.colorName : ''}
                                            </small>
                                            {cart.color && (
                                            <span
                                    ...
                                    <td className="text-end" data-label="單價">
                                        ...
                                        <del className="fs-7 text-body-tertiary me-2 flex-fill">
                                    ...
                                    <td className="text-end" data-label="數量">
                                        ...
                                        <button
                                            type="button"
                                            className="btn qtyBtn btn-sm p-0 ps-2 d-flex align-items-center rounded-end"
                                        ...
                                        <button
                                            type="button"
                                            className="btn qtyBtn btn-sm p-0 ps-1 d-flex align-items-center rounded-start"
                                            style={{ width: '32px', height: '32px' }}
                                            onClick={() =>
                                            updateCart(cart.id, cart.product.title, cart.qty + 1, cart.color)
                                            }
                                        ...
                                        <span className="fs-7 border-0 pe-0 ms-1">{cart.product.unit}</span>
                                        </div>
                                    </td>
                                    <td className="text-end" data-label="小計">
                                        ...
                                        <span className="flex-fill">
                                            ...
                                            <del className="fs-7 text-body-tertiary me-2">
                                    ...
                                    <td className="text-end mb-5 mb-lg-0">
                                        <button
                                            type="button"
                                            className="btn deleteBtn btn-sm px-2"
                            ...
                            <div className="row">
                                <div className={`col-lg-4 ${cartList.carts?.length >= 1 && 'pb-5'}`}>
                                    <div className="d-flex">
                                        ...
                                        <button
                                            type="text"
                                            className="btn couponBtn d-inline-flex align-items-center justify-content-center gap-2"
                                ...
                                <div className="col-lg-8" style={{ paddingRight: !isMobile && '120px' }}>
                                    <div className="d-flex align-items-center justify-content-between justify-content-lg-end pb-2">
                                        ...
                                        <b
                                            className={` ${
                                            cartList.total > cartList.final_total ? '' : 'h5 text-blue'
                                            } `}
                                        >
                ...
                <section className="orderInfo py-5 mb-5">
                    ...
                    <form className="col-md-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <label htmlFor="email" className="form-label d-flex align-content-center m-0">
                            Email<span className="text-blue fs-5 ms-1">*</span>
                        </label>
                        <input
                            id="email"
                            type="email"
                        ...
                        />
                        {errors.email && (
                            <p className="textBody3 text-blue my-2">{errors.email.message}</p>
                        )}
                        </div>
                        <div className="mb-3">
                        <label htmlFor="name" className="form-label d-flex align-content-center m-0">
                            收件人姓名<span className="text-blue fs-5 ms-1">*</span>
                        </label>
                        <input
                            id="name"
                            type="text"
                        ...
                        />
                        {errors.name && (
                            <p className="textBody3 text-blue my-2">{errors.name.message}</p>
                        )}
                        </div>
                        <div className="mb-3">
                        <label htmlFor="tel" className="form-label d-flex align-content-center m-0">
                            收件人電話<span className="text-blue fs-5 ms-1">*</span>
                        </label>
                        <input
                            id="tel"
                            type="tel"
                        ...
                        />
                        {errors.tel && (
                            <p className="textBody3 text-blue my-2">{errors.tel.message}</p>
                        )}
                        </div>
                        <div className="mb-3">
                        <label htmlFor="address" className="form-label d-flex align-content-center m-0">
                            收件人地址<span className="text-blue fs-5 ms-1">*</span>
                        </label>
                        <input
                            id="address"
                            type="text"
                        ...
                        />
                        {errors.address && (
                            <p className="textBody3 text-blue my-2">{errors.address.message}</p>
                        )}
                        </div>
                        <div className="mb-3">
                        ...
                        <span className="d-flex align-content-center" style={{ minWidth: '90px' }}>
                            付款方式<span className="text-blue fs-5 ms-1">*</span>
                        </span>
                        <div className="d-flex flex-column flex-fill gap-3 ps-0 ps-md-4">
                            ...
                            {errors.paymond && (
                            <p className="textBody3 text-blue my-2">{errors.paymond.message}</p>
                            )}
                            {paymond === '線上刷卡' && (
                            <div className="creditInfo ms-4">
                                ...
                                >
                                    卡號<span className="text-blue fs-5 ms-1">*</span>
                                </label>
                                <input
                                    id="cardNumber"
                                    type="text"
                                ...
                                />
                                {errors.cardNumber && (
                                    <p className="textBody3 text-blue my-2">
                                ...
                                <div className="flex-fill">
                                    <label
                                        ...
                                        className="form-label d-flex align-content-center m-0"
                                    >
                                    有效日期<span className="text-blue fs-5 ms-1">*</span>
                                    </label>
                                    <input
                                        id="dueDate"
                                        type="text"
                                ...
                                <div className="flex-fill">
                                    ...
                                    className="form-label d-flex align-content-center m-0"
                                    >
                                    卡片驗證碼<span className="text-blue fs-5 ms-1">*</span>
                                    </label>
                                    <input
                                        id="cvv"
                                        type="text"
                                    ...
                                    />
                                    {errors.cvv && (
                                    <p className="textBody3 text-blue my-2">{errors.cvv.message}</p>
                                    )}
                                </div>
                                </div>
                            </div>
