            ...
            <section>
                <div className="table-responsive p-4 bg-white rounded-4">
                    ...
                    <table className="table align-middle adminTable">
                        <thead>
                            <tr>
                                <th scope="col" width={50} className="fs-7">
                                    No.
                                </th>
                                <th scope="col">分類</th>
                        ...
                        <tbody>
                            {productsData && productsData.length > 0 ? (
                                productsData.map((product) => (
                                    <tr key={product.id}>
                                        <td>
                                            <span className="fs-7">{product.num}</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <span>
                                                <br />
                                                {product.is_newest && (
                                                    <span className="tag tag-newest fs-6 me-2">
                                                        <span className="material-icons fs-7 me-1">verified</span>
                                                        新品上架
                                                    </span>
                                                )}
                                                {product.is_hottest && (
                                                    <span className="tag tag-hottest fs-7">
                                                        <span className="material-icons fs-6 me-1">
                                                ...
                                                {/* 只要售價 < 原價，產品品項就會自動產生「限時優惠」的 label */}
                                                {product.origin_price > product.price && (
                                                    <span className="tag tag-cheaper fs-7">
                                                        <span className="material-icons fs-6 me-1">timer</span>
                                                        限時優惠
                                                    </span>
                                                )}
                                            </span>
